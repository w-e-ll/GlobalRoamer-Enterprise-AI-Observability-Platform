...
from globalroamer_platform.api.dependencies.trace_submission import (
    get_submit_trace,
)
...
async def submit_trace(
    ...
    """Accept a server-side trace file for asynchronous processing."""
